...
left_arm_joint1_max_acce = 2 * (180 / math.pi)
left_arm_joint2_max_acce = 2 * (180 / math.pi)
left_arm_joint3_max_acce = 3 * (180 / math.pi)
left_arm_joint4_max_acce = 3 * (180 / math.pi)
...
right_arm_joint1_max_acce = 2 * (180 / math.pi)
right_arm_joint2_max_acce = 2 * (180 / math.pi)
right_arm_joint3_max_acce = 3 * (180 / math.pi)
right_arm_joint4_max_acce = 3 * (180 / math.pi)
