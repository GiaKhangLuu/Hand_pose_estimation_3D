...
def custom_loss_function(pred, gt):
    ...
    wrist_loss = calculate_wrist_loss(pred, gt)
    index_mcp_loss = calculate_index_finger_mcp_loss(pred, gt)
    middle_mcp_loss = calculate_middle_finger_mcp_loss(pred, gt)
    ...
    loss = (
        ...
        loss_each_landmark + 
        0.5 * loss_each_finger +
        0.5 * loss_distance_of_thumb_pinky_and_index_ring +
        1.1 * wrist_loss +
        1.1 * index_mcp_loss + 
        1.1 * middle_mcp_loss
        )
