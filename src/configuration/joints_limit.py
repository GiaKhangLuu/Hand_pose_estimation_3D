...
left_arm_joint1_max_acce = 6 * (180 / math.pi)
left_arm_joint2_max_acce = 6 * (180 / math.pi)
left_arm_joint3_max_acce = 8 * (180 / math.pi)
left_arm_joint4_max_acce = 8 * (180 / math.pi)
left_arm_joint5_max_acce = 12 * (180 / math.pi)
left_arm_joint6_max_acce = 12 * (180 / math.pi)
